    ...
    <tr>
        <td bgcolor="#FFFFFF">
            ...
            <form action="" method="post" name="submitxiugai">
                ...
                注册时间：<?php echo date("Y-m-d H:i",$row['utime']);?><br /><br />
                电子邮箱 <input for="Email" name="email" id="email" value="<?echo $row[email];
                ?>"> <br /><br />
                ...
                授权用户密码：<input type="text" name="cpassword" id="cpassword" value="<?php echo $row['cpassword'];?>" size="18" maxlength="15" /><br /><br />授权用户直接到 <a href="client.php">client页面</a> 用你的用户名和授权密码添加数据，只能添加，无法修改删除，密码留空则无效。<br /><br />
                <input name="Submitxiugai" type="submit" value="提交" class="btn btn-default" />
                <?php
                if (isset($_POST['Submitxiugai'])) {
