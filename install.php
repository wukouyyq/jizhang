...
<head>
    ...
    <p align="center">
        ...
        $field = mysql_query('Describe '.$qianzui.'user cpassword');
        //像数据库发送SQL语句
        ...
        if ($field[0]) {
            ...
            $sql = mysql_query("ALTER TABLE `".$qianzui."user` ADD `cpassword` VARCHAR(35) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL");
            echo "升级成功！<br />";
        }
