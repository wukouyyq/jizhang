...
while ($row = mysql_fetch_array($query)) {
    ...
    if ($classinfo['classtype'] == 1) {
        $zuorishou = $zuorishou+$row['acmoney'];
    } else {
        $zuorifu = $zuorifu+$row['acmoney'];
    }
}
//前周收付统计
...
$tj = mktime(23,59,59,date("m",$t)-1,date("t",$t),date("Y",$t));
$j = date("Y-m-d",$tj);
$k = date("Y-m-d",$tk);
...
<table width='100%' border='0' align='left' cellpadding='5' cellspacing='1' bgcolor='#B3B3B3' class='table table-striped table-bordered'>
    ...
    <tr><td align='left' width="20%" bgcolor='#FFFFFF'><font color="red">支出</font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font color="red" id="ri2"><?php echo $rifu; ?></font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font color="red" id="zhou2"><?php echo $zhoufu; ?></font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font color="red" id="yue2"><?php echo $yuefu; ?></font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font color="red" id="nian2"><?php echo $nianfu; ?></font></td>
    </tr>
    <tr><td align='left' width="20%" bgcolor='#FFFFFF'><font color="MediumSeaGreen">收入</font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font color="MediumSeaGreen" id="ri1"><?php echo $rishou; ?></font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font color="MediumSeaGreen" id="zhou1"><?php echo $zhoushou; ?></font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font color="MediumSeaGreen" id="yue1"><?php echo $yueshou; ?></font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font color="MediumSeaGreen" id="nian1"><?php echo $nianshou; ?></font></td>
    </tr>

    <tr><td align='left' width="20%" bgcolor='#FFFFFF'><font>剩余</font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font id="sri"><?php echo $rishou-$rifu; ?></font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font id="szhou"><?php echo $zhoushou-$zhoufu; ?></font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font id="syue"><?php echo $yueshou-$yuefu; ?></font></td>
        <td align='left' width="20%" bgcolor='#FFFFFF'><font id="snian"><?php echo $nianshou-$nianfu; ?></font></td>
    </tr>
</table>
...
<table width='100%' border='0' align='left' cellpadding='5' cellspacing='1' bgcolor='#B3B3B3' class='table table-striped table-bordered'>
    ...
    <tr><td align='left' width="20%" bgcolor='#FFFFFF'><font color="red">支出</font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font color="red" id="qianri2"><?php echo $zuorifu; ?></font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font color="red" id="qianzhou2"><?php echo $qianzhoufu; ?></font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font color="red" id="qianyue2"><?php echo $qianyuefu; ?></font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font color="red" id="qiannian2"><?php echo $qiannianfu; ?></font></td>
    </tr>
    <tr><td align='left' width="20%" bgcolor='#FFFFFF'><font color="MediumSeaGreen">收入</font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font color="MediumSeaGreen" id="qianri1"><?php echo $zuorishou; ?></font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font color="MediumSeaGreen" id="qianzhou1"><?php echo $qianzhoushou; ?></font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font color="MediumSeaGreen" id="qianyue1"><?php echo $qianyueshou; ?></font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font color="MediumSeaGreen" id="qiannian1"><?php echo $qiannianshou; ?></font></td>
    </tr>

    <tr><td align='left' width="20%" bgcolor='#FFFFFF'><font>剩余</font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font id="sqianri"><?php echo $zuorishou-$zuorifu; ?></font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font id="sqianzhou"><?php echo $qianzhoushou-$qianzhoufu; ?></font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font id="sqianyue"><?php echo $qianyueshou-$qianyuefu; ?></font></td>
        <td width="20%" align='left' bgcolor='#FFFFFF'><font id="sqiannian"><?php echo $qiannianshou-$qiannianfu; ?></font></td>
    </tr>
</table>
...
$query_sql = "SELECT * FROM ".$qianzui."account where jiid='".$_SESSION['uid']."' ORDER BY actime DESC";//  $offset , $pagesize";
...
<script language="javascript">
    ...
    document.getElementById("qianri1").innerHTML = "<?=$zuorishou ?>"
    document.getElementById("qianri2").innerHTML = "<?=$zuorifu ?>"
    document.getElementById("sqianri").innerHTML = "<?=$zuorishou-$zuorifu ?>"
