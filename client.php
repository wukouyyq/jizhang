                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            ...
                            <form action="" method="get" name="submitdl">
                                ...
                                if (isset($_GET['submitdl'])) {
                                    $user = $_GET['username'];
                                    $upass = $_GET['password'];
                                    $result = mysql_query("SELECT * FROM jizhang_user WHERE username='$user'");
            ...
            if (isset($_GET['Submit'])) {
                if ($_SESSION[uuid] != "") {
                    ...
                    foreach ($path as $key => $value) {
                        ...
                        $query = mysql_query("insert into ".$qianzui."account (acmoney, acclassid, actime, acremark,zhifu,jiid) values('$value','".$path1[$key]."','$time100','".$path3[$key]."','".$path4[$key]."','$_SESSION[uuid]')");
...
//分页代码
//计算总数
$count_result = mysql_query("SELECT count(*) as count FROM ".$qianzui."account where jiid='$_SESSION[uuid]'");
