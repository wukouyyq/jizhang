...
<div>
<input name="zhifu[]" id="zhifu" type="text" value="2" style="display:none;" /><font color="red">金额：</font><input type="text" name="money[]" id="money" value="" style="width:70px;" /><font color="red"> 分类：</font><select name="classid[]" style="height:26px;">
<?php
$sql = "select * from ".$qianzui."account_class where classtype=2 and ufid='".$_SESSION['uid']."'";
$query = mysql_query($sql);
while ($acclass = mysql_fetch_array($query)) {
